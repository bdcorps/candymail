...
describe('Unit Tests', () => {
  ...
  test('should get all messages in the db before time', async () => {
    const messages = await getScheduledMessagesBeforeTime(new Date(Date.parse("2020-08-20T02:30:30")))
  ...
  test('add scheduled message', async () => {
    await addScheduledMessage({ body: "asd", sendTo: "d", sendFrom: "d", template: "d", subject: "sda", sendAt: new Date(Date.parse("2020-08-20T02:30:30")) })
